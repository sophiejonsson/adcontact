...
export const metadata: Metadata = {
  ...
  description:
    "Surplus component stock from Adcontact's own warehouse, at outlet pricing while quantities last.",
        ...
        <div className="relative mx-auto max-w-[1440px] px-6 py-6">
          ...
          <div className="mt-5 max-w-3xl">
            ...
            <p className="mt-4 text-base leading-7 text-[#94a3b8]">
              We are putting together an outlet selection from our own surplus stock, sold as-is at
              reduced prices while quantities last. In the meantime, tell us what you are looking
              for and we will check what we have.
            </p>
          </div>
        </div>
      </section>
      ...
      <main className="mx-auto max-w-[1440px] px-6 py-10">
        <section className="rounded-2xl border border-[#e2e8f0] bg-white px-6 py-7 sm:px-8">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-[#475569]">
            Tell us the part number, brand or application, and we will check whether it is
            available in our outlet stock.
          </p>
