  ...
  return (
    <section className="bg-canvas py-8 sm:py-10 md:py-12 lg:py-12">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
        <div className="bg-gradient-to-br from-[#0a1628] to-[#1a2f5a] rounded-[16px] sm:rounded-2xl p-5 sm:p-7 md:p-8 lg:p-10 relative overflow-hidden ring-1 ring-white/5 shadow-[0_30px_80px_-20px_rgba(10,22,40,0.5)]">
